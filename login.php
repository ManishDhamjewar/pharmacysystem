        ...
        <div class="card-body">
		  ...
		  <div class="logo">
            ...
            <div class="input-group form-group">
              ...
              <input name="username" type="text" class="form-control" placeholder="type admin here" onkeyup="validate();" required>
            </div> <!--input-group class -->
            <div class="input-group form-group">
              <div class="input-group-prepend">
                <span class="input-group-text"><i class="fas fa-key text-white"></i></span>
              </div>
              <input name="password" type="password" class="form-control" placeholder="type admin123 here" onkeyup="validate();" required>
            </div> <!-- input-group class -->
