      ...
      <div class="card m-auto p-2">
        <div class="card-body">
            ...
            <div class="form-group">
              <button style="background-color:red; border-color:blue; color:white" class="btn btn-default btn-block btn-custom" onclick="window.location.href='http://localhost/Pharmacy-Management1/login.php';">Go to Login Page</button>
